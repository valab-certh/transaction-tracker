...
function createOrderer() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:9054 --caname ca-orderer --tls.certfiles "${PWD}/organizations/fabric-ca/Orderer/tls-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer1:orderer1pw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/orderer.iti.gr/orderers/orderer1.orderer.iti.gr/msp" --csr.hosts orderer1.orderer.iti.gr --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/Orderer/tls-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://orderer1:orderer1pw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/orderer.iti.gr/orderers/orderer1.orderer.iti.gr/tls"  --csr.hosts orderer1.orderer.iti.gr --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/Orderer/tls-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/orderer.iti.gr/users/Admin@orderer.iti.gr/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/Orderer/tls-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
