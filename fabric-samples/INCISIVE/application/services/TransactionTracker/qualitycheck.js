...
const qualitycheck = async(req, res, next) => {
    ...
    try {
        ...
        // signed by this user using the credentials stored in the wallet.
            ...
            let result= await contract.submitTransaction('QualityCheck', data, identity, secret);
        ...
        console.log('New critical action (data quality check) submission failed with error: '+error);

        res.status(403).send('New critical action (data quality check) submission failed ...')
