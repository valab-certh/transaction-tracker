...
const annotateAI = async(req, res, next) => {
    ...
    try {
        ...
        // signed by this user using the credentials stored in the wallet.
            ...
            let result = await contract.submitTransaction('AnnotateAI', data, identity, secret);
        ...
        console.log('New critical action (annotate data with AI models) submition failed with error: '+error);

        res.status(403).send('New critical action (annotate data with AI models) submition failed ...')
        

    }
    
}
module.exports = annotateAI;