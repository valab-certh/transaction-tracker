...
const deidentify = async(req, res, next) => {
    ...
    try {
        ...
        console.log('New critical action (anonymize data) submission failed with error: '+error);

        res.status(403).send('New critical action (anonymize data) submission failed ...')
